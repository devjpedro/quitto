...
| **4b** | Participantes + convites (UI) | Gerenciar participantes, gerar/copiar link de convite, tela de aceitar convite, exibir nome do ator na timeline. Consome os endpoints da 4a. | a escrever |
