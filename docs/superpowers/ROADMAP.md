...
| **2b** | Contratos + Parcelas (UI) | Tela de contrato (stats + progresso + abas) + painel lateral (drawer) da parcela, assistente de criação em 3 passos, lista/navegação entre contratos. Criar/ver contratos solo ponta a ponta. | a escrever |
