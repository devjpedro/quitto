...
| **6b** | Recibo/quitação + export | Recibo/quitação em PDF, export CSV/PDF dos contratos/parcelas. | a escrever |
| **6c** | LGPD | Exportar dados do usuário, excluir conta. | a escrever |
